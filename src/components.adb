...
package body Components is
   ...
   procedure Destroy (Widget: access Gtk.Widget.Gtk_Widget_Record'Class) is
    ...
    procedure Sign_Change(Button: access Gtk.Button.Gtk_Button_Record'Class) is
        F: My_Float;
    begin
    ...
    procedure Angle_Change(Button: access Gtk.Button.Gtk_Button_Record'Class) is
    begin
        case Angle is
            when Deg =>
                Angle := Rad;
